...
public class LSysFractals {
    ...
    // Creates a new Block with the id "lsysfractals:example_block", combining the namespace and path
    public static final DeferredBlock<Block> LSYS_VAR_BLOCK = BLOCKS.registerBlock("LSysVar",
